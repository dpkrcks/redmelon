...
export function Button({
  ...
  const variants = {
    primary:
      "rounded-xl bg-[var(--accent)] px-5 py-3 text-white shadow-[0_8px_20px_rgba(178,58,46,0.34)] hover:-translate-y-0.5 hover:bg-[var(--accent-strong)] hover:shadow-[0_14px_34px_rgba(178,58,46,0.28)]",
    secondary:
